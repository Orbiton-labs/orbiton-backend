...
const { BN, compareBytes, bytesToBase64, base64ToBytes, concatBytes } = utils;
// } = require("../utils");
...
export class BlockId {
  ...
  constructor(o) {
    if (o && o.file_hash) {
      ...
      else this.file_hash = new Uint32Array(o.file_hash.buffer);
    } else {
    ...
    if (o && o.root_hash) {
      ...
      else this.root_hash = new Uint32Array(o.root_hash.buffer);
    } else {
      this.root_hash = new Uint32Array();
    }
    this.workchain = o ? o.workchain : 0;
    if (o && o.shard) {
      if (typeof o.shard === 'string') this.shard = new BN(o.shard, 16);
      else this.shard = o.shard.clone();
    } else {
      this.shard = new BN(0);
    }
