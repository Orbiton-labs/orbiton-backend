...
export type HashmapAugNode<X, Y> =
  | HashmapAugNode_ahmn_leaf<X, Y>
  | HashmapAugNode_ahmn_fork<X, Y>;
...
export type VarHashmapNode<X> =
  | VarHashmapNode_vhmn_leaf<X>
  | VarHashmapNode_vhmn_fork<X>
  | VarHashmapNode_vhmn_cont<X>;
...
export type VarHashmapE<X> =
  | VarHashmapE_vhme_empty<X>
  | VarHashmapE_vhme_root<X>;
...
export type PfxHashmapNode<X> =
  | PfxHashmapNode_phmn_leaf<X>
  | PfxHashmapNode_phmn_fork<X>;
...
export type PfxHashmapE<X> =
  | PfxHashmapE_phme_empty<X>
  | PfxHashmapE_phme_root<X>;
...
export type CommonMsgInfoRelaxed =
  | CommonMsgInfoRelaxed_int_msg_info
  | CommonMsgInfoRelaxed_ext_out_msg_info;
...
export type IntermediateAddress =
  | IntermediateAddress_interm_addr_regular
  | IntermediateAddress_interm_addr_simple
  | IntermediateAddress_interm_addr_ext;
...
export type MsgEnvelope =
  | MsgEnvelope_msg_envelope
  | MsgEnvelope_msg_envelope_v2;
...
export interface MsgEnvelope_msg_envelope_v2 {
  ...
  readonly fwd_fee_remaining: bigint;
  readonly msg: Message<Cell>;
  readonly emitted_lt: Maybe<number>;
...
export type InMsg =
  | InMsg_msg_import_ext
  | InMsg_msg_import_ihr
  | InMsg_msg_import_imm
  | InMsg_msg_import_fin
  | InMsg_msg_import_tr
  | InMsg_msg_discard_fin
  | InMsg_msg_discard_tr
  | InMsg_msg_import_deferred_fin
  | InMsg_msg_import_deferred_tr;
...
export type OutMsg =
  | OutMsg_msg_export_ext
  | OutMsg_msg_export_imm
  | OutMsg_msg_export_new
  | OutMsg_msg_export_tr
  | OutMsg_msg_export_deq
  | OutMsg_msg_export_deq_short
  | OutMsg_msg_export_tr_req
  | OutMsg_msg_export_deq_imm
  | OutMsg_msg_export_new_defer
  | OutMsg_msg_export_deferred_tr;
...
export interface OutMsgDescr {
  ...
  readonly anon0: Dictionary<
    bigint,
    { value: OutMsg; extra: CurrencyCollection }
  >;
}
...
export interface AccountDispatchQueue {
  ...
  readonly messages: Dictionary<number, EnqueuedMsg>;
...
export interface DispatchQueue {
  ...
  readonly anon0: Dictionary<
    bigint,
    { value: AccountDispatchQueue; extra: number }
  >;
}
...
export interface OutMsgQueueExtra {
  ...
  readonly out_queue_size: Maybe<number>;
}
...
export type AccountState =
  | AccountState_account_uninit
  | AccountState_account_active
  | AccountState_account_frozen;
...
export type AccountStatus =
  | AccountStatus_acc_state_uninit
  | AccountStatus_acc_state_frozen
  | AccountStatus_acc_state_active
...
export interface ShardAccounts {
  ...
  readonly anon0: Dictionary<
    bigint,
    { value: ShardAccount; extra: DepthBalanceInfo }
  >;
}
...
export interface ShardAccountBlocks {
  ...
  readonly anon0: Dictionary<
    bigint,
    { value: AccountBlock; extra: CurrencyCollection }
  >;
}
...
export type AccStatusChange =
  | AccStatusChange_acst_unchanged
  | AccStatusChange_acst_frozen
  | AccStatusChange_acst_deleted;
...
export type TrComputePhase =
  | TrComputePhase_tr_phase_compute_skipped
  | TrComputePhase_tr_phase_compute_vm;
...
export type ComputeSkipReason =
  | ComputeSkipReason_cskip_no_state
  | ComputeSkipReason_cskip_bad_state
  | ComputeSkipReason_cskip_no_gas
  | ComputeSkipReason_cskip_suspended;
...
export type TrBouncePhase =
  | TrBouncePhase_tr_phase_bounce_negfunds
  | TrBouncePhase_tr_phase_bounce_nofunds
  | TrBouncePhase_tr_phase_bounce_ok;
...
export type TransactionDescr =
  | TransactionDescr_trans_ord
  | TransactionDescr_trans_storage
  | TransactionDescr_trans_tick_tock
  | TransactionDescr_trans_split_prepare
...
export type OutAction =
  | OutAction_action_send_msg
  | OutAction_action_set_code
  | OutAction_action_reserve_currency
  | OutAction_action_change_library;
...
export type BlkPrevInfo =
  | BlkPrevInfo_prev_blk_info
  | BlkPrevInfo_prev_blks_info;
...
export type FutureSplitMerge =
  | FutureSplitMerge_fsm_none
  | FutureSplitMerge_fsm_split
  | FutureSplitMerge_fsm_merge;
...
export type BinTreeAug<X, Y> =
  | BinTreeAug_bta_leaf<X, Y>
  | BinTreeAug_bta_fork<X, Y>;
...
export interface ShardFees {
  ...
  readonly anon0: Dictionary<
    bigint,
    { value: ShardFeeCreated; extra: ShardFeeCreated }
  >;
}
...
export type BlockCreateStats =
  | BlockCreateStats_block_create_stats
  | BlockCreateStats_block_create_stats_ext;
...
export type CryptoSignature =
  | CryptoSignature_chained_signature
  | CryptoSignature__;
...
export type ValidatorDescr =
  | ValidatorDescr_validator
  | ValidatorDescr_validator_addr;
...
export type ConfigParam =
  ...
  | ConfigParam__18
  | ConfigParam__19
  | ConfigParam_config_mc_gas_prices
  | ConfigParam_config_gas_prices
  | ConfigParam_config_mc_block_limits
  | ConfigParam_config_block_limits
  | ConfigParam_config_mc_fwd_prices
  | ConfigParam_config_fwd_prices
  | ConfigParam__26
  | ConfigParam__27
  | ConfigParam__28
  | ConfigParam__29
...
export type WorkchainFormat =
  | WorkchainFormat_wfmt_basic
  | WorkchainFormat_wfmt_ext;
...
export type WorkchainDescr =
  | WorkchainDescr_workchain
  | WorkchainDescr_workchain_v2;
...
export type CatchainConfig =
  | CatchainConfig_catchain_config
...
export type ConsensusConfig =
  | ConsensusConfig_consensus_config
  | ConsensusConfig_consensus_config_new
  | ConsensusConfig_consensus_config_v3
...
export type SizeLimitsConfig =
  | SizeLimitsConfig_size_limits_config
  | SizeLimitsConfig_size_limits_config_v2;
...
export type JettonBridgeParams =
  | JettonBridgeParams_jetton_bridge_params_v0
...
export type ComplaintDescr =
  | ComplaintDescr_no_blk_gen
  | ComplaintDescr_no_blk_gen_diff;
...
export type VmStackValue =
  | VmStackValue_vm_stk_null
  | VmStackValue_vm_stk_tinyint
  | VmStackValue_vm_stk_int
  | VmStackValue_vm_stk_nan
  | VmStackValue_vm_stk_cell
  | VmStackValue_vm_stk_slice
  | VmStackValue_vm_stk_builder
  | VmStackValue_vm_stk_cont
  | VmStackValue_vm_stk_tuple;
...
export type VmTupleRef =
  | VmTupleRef_vm_tupref_nil
  | VmTupleRef_vm_tupref_single
  | VmTupleRef_vm_tupref_any;
...
export type VmCont =
  ...
  | VmCont_vmc_until
  | VmCont_vmc_again
  | VmCont_vmc_while_cond
  | VmCont_vmc_while_body
  | VmCont_vmc_pushint;
...
export type TextChunkRef =
  | TextChunkRef_chunk_ref_empty
  | TextChunkRef_chunk_ref;
...
export type SmcCapability =
  | SmcCapability_cap_method_seqno
  | SmcCapability_cap_method_pubkey
  | SmcCapability_cap_is_wallet
  | SmcCapability_cap_name;
...
export type ChanState =
  | ChanState_chan_state_init
  | ChanState_chan_state_close
  | ChanState_chan_state_payout;
...
export type ChanMsg =
  | ChanMsg_chan_msg_init
  | ChanMsg_chan_msg_close
  | ChanMsg_chan_msg_timeout
  | ChanMsg_chan_msg_payout;
...
export function loadBoolFalse(slice: Slice): BoolFalse {
  ...
  throw new Error(
    'Expected one of "BoolFalse" in loading "BoolFalse", but data does not satisfy any constructor'
  );
}

export function storeBoolFalse(
  boolFalse: BoolFalse
...
export function loadBoolTrue(slice: Slice): BoolTrue {
  ...
  throw new Error(
    'Expected one of "BoolTrue" in loading "BoolTrue", but data does not satisfy any constructor'
  );
}
...
export function loadEither<X, Y>(
  slice: Slice,
  loadX: (slice: Slice) => X,
  loadY: (slice: Slice) => Y
): Either<X, Y> {
...
export function hashmap_get_l(label: HmLabel): number {
  ...
  throw new Error(
    'Expected one of "HmLabel_hml_short", "HmLabel_hml_long", "HmLabel_hml_same" for type "HmLabel" while getting "label", but data does not satisfy any constructor'
  );
}
...
export function storeHashmap<X>(
  hashmap: Hashmap<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadHashmapNode<X>(
  slice: Slice,
  arg0: number,
  loadX: (slice: Slice) => X
): HashmapNode<X> {
  ...
  throw new Error(
    'Expected one of "HashmapNode_hmn_leaf", "HashmapNode_hmn_fork" in loading "HashmapNode", but data does not satisfy any constructor'
  );
}

export function storeHashmapNode<X>(
  hashmapNode: HashmapNode<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
...
export function hmLabel_hml_short_get_n(len: Unary): number {
  ...
  throw new Error(
    'Expected one of "Unary_unary_zero", "Unary_unary_succ" for type "Unary" while getting "len", but data does not satisfy any constructor'
  );
}
...
export function loadHmLabel(slice: Slice, m: number): HmLabel {
  if (slice.remainingBits >= 1 && slice.preloadUint(1) == 0b0) {
    ...
    if (!(n <= m)) {
      throw new Error(
        'Condition (n <= m) is not satisfied while loading "HmLabel_hml_short" for type "HmLabel"'
      );
    }
    return {
  ...
  throw new Error(
    'Expected one of "HmLabel_hml_short", "HmLabel_hml_long", "HmLabel_hml_same" in loading "HmLabel", but data does not satisfy any constructor'
  );
}
  ...
  if (hmLabel.kind == "HmLabel_hml_short") {
    return (builder: Builder) => {
      ...
      if (!(hmLabel.n <= hmLabel.m)) {
        throw new Error(
          'Condition (hmLabel.n <= hmLabel.m) is not satisfied while loading "HmLabel_hml_short" for type "HmLabel"'
        );
      }
    };
  }
...
export function unary_unary_succ_get_n(x: Unary): number {
  ...
  throw new Error(
    'Expected one of "Unary_unary_zero", "Unary_unary_succ" for type "Unary" while getting "x", but data does not satisfy any constructor'
  );
}
...
export function loadUnary(slice: Slice): Unary {
  ...
  throw new Error(
    'Expected one of "Unary_unary_zero", "Unary_unary_succ" in loading "Unary", but data does not satisfy any constructor'
  );
}
...
export function storeBitstringSet(
  bitstringSet: BitstringSet
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadHashmapAug<X, Y>(
  slice: Slice,
  n: number,
  loadX: (slice: Slice) => X,
  loadY: (slice: Slice) => Y
  ...
  let node: HashmapAugNode<X, Y> = loadHashmapAugNode<X, Y>(
    slice,
    n - l,
    loadX,
    loadY
...
export function storeHashmapAug<X, Y>(
  hashmapAug: HashmapAug<X, Y>,
  storeX: (x: X) => (builder: Builder) => void,
  storeY: (y: Y) => (builder: Builder) => void
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadHashmapAugNode<X, Y>(
  slice: Slice,
  arg0: number,
  loadX: (slice: Slice) => X,
  loadY: (slice: Slice) => Y
  ...
  if (true) {
    let slice1 = slice.loadRef().beginParse(true);
    let left: HashmapAug<X, Y> = loadHashmapAug<X, Y>(
      slice1,
      arg0 - 1,
      loadX,
      loadY
    ...
    let slice2 = slice.loadRef().beginParse(true);
    let right: HashmapAug<X, Y> = loadHashmapAug<X, Y>(
      slice2,
      arg0 - 1,
      loadX,
      loadY
  ...
  throw new Error(
    'Expected one of "HashmapAugNode_ahmn_leaf", "HashmapAugNode_ahmn_fork" in loading "HashmapAugNode", but data does not satisfy any constructor'
  );
}

export function storeHashmapAugNode<X, Y>(
  hashmapAugNode: HashmapAugNode<X, Y>,
  storeX: (x: X) => (builder: Builder) => void,
  storeY: (y: Y) => (builder: Builder) => void
): (builder: Builder) => void {
...
export function loadVarHashmap<X>(
  slice: Slice,
  n: number,
  loadX: (slice: Slice) => X
): VarHashmap<X> {
...
export function storeVarHashmap<X>(
  varHashmap: VarHashmap<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadVarHashmapNode<X>(
  slice: Slice,
  arg0: number,
  loadX: (slice: Slice) => X
): VarHashmapNode<X> {
  ...
  throw new Error(
    'Expected one of "VarHashmapNode_vhmn_leaf", "VarHashmapNode_vhmn_fork", "VarHashmapNode_vhmn_cont" in loading "VarHashmapNode", but data does not satisfy any constructor'
  );
}

export function storeVarHashmapNode<X>(
  varHashmapNode: VarHashmapNode<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
...
export function loadVarHashmapE<X>(
  slice: Slice,
  n: number,
  loadX: (slice: Slice) => X
): VarHashmapE<X> {
  ...
  throw new Error(
    'Expected one of "VarHashmapE_vhme_empty", "VarHashmapE_vhme_root" in loading "VarHashmapE", but data does not satisfy any constructor'
  );
}

export function storeVarHashmapE<X>(
  varHashmapE: VarHashmapE<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
...
export function loadPfxHashmap<X>(
  slice: Slice,
  n: number,
  loadX: (slice: Slice) => X
): PfxHashmap<X> {
...
export function storePfxHashmap<X>(
  pfxHashmap: PfxHashmap<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadPfxHashmapNode<X>(
  slice: Slice,
  arg0: number,
  loadX: (slice: Slice) => X
): PfxHashmapNode<X> {
  ...
  throw new Error(
    'Expected one of "PfxHashmapNode_phmn_leaf", "PfxHashmapNode_phmn_fork" in loading "PfxHashmapNode", but data does not satisfy any constructor'
  );
}

export function storePfxHashmapNode<X>(
  pfxHashmapNode: PfxHashmapNode<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
...
export function loadPfxHashmapE<X>(
  slice: Slice,
  n: number,
  loadX: (slice: Slice) => X
): PfxHashmapE<X> {
  ...
  throw new Error(
    'Expected one of "PfxHashmapE_phme_empty", "PfxHashmapE_phme_root" in loading "PfxHashmapE", but data does not satisfy any constructor'
  );
}

export function storePfxHashmapE<X>(
  pfxHashmapE: PfxHashmapE<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
...
export function loadAnycast(slice: Slice): Anycast {
  ...
  if (!(depth >= 1)) {
    throw new Error(
      'Condition (depth >= 1) is not satisfied while loading "Anycast" for type "Anycast"'
    );
  }
  return {
    kind: "Anycast",
...
export function loadExtraCurrencyCollection(
  slice: Slice
): ExtraCurrencyCollection {
  let dict: Dictionary<number, bigint> = Dictionary.load(
...
export function storeExtraCurrencyCollection(
...
export function storeCurrencyCollection(
...
export function loadCommonMsgInfo(slice: Slice): CommonMsgInfo {
  ...
  throw new Error(
    'Expected one of "CommonMsgInfo_int_msg_info", "CommonMsgInfo_ext_in_msg_info", "CommonMsgInfo_ext_out_msg_info" in loading "CommonMsgInfo", but data does not satisfy any constructor'
  );
}

export function storeCommonMsgInfo(
...
export function loadCommonMsgInfoRelaxed(slice: Slice): CommonMsgInfoRelaxed {
  ...
  throw new Error(
    'Expected one of "CommonMsgInfoRelaxed_int_msg_info", "CommonMsgInfoRelaxed_ext_out_msg_info" in loading "CommonMsgInfoRelaxed", but data does not satisfy any constructor'
  );
}

export function storeCommonMsgInfoRelaxed(
  commonMsgInfoRelaxed: CommonMsgInfoRelaxed
): (builder: Builder) => void {
...
export function storeStateInit(
  stateInit: StateInit
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadStateInitWithLibs(slice: Slice): StateInitWithLibs {
  ...
  let library: Dictionary<bigint, SimpleLib> = Dictionary.load(
...
export function storeStateInitWithLibs(
  stateInitWithLibs: StateInitWithLibs
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function storeSimpleLib(
  simpleLib: SimpleLib
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadMessage<X>(
  slice: Slice,
  loadX: (slice: Slice) => X
): Message<X> {
  let info: CommonMsgInfo = loadCommonMsgInfo(slice);
  let init: Maybe<Either<StateInit, StateInit>> = loadMaybe<
    Either<StateInit, StateInit>
  >(slice, (slice: Slice) => {
    return loadEither<StateInit, StateInit>(
      slice,
      loadStateInit,
      (slice: Slice) => {
        let slice1 = slice.loadRef().beginParse(true);
...
export function storeMessage<X>(
  message: Message<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
  return (builder: Builder) => {
    storeCommonMsgInfo(message.info)(builder);
    storeMaybe<Either<StateInit, StateInit>>(
      message.init,
      (arg: Either<StateInit, StateInit>) => {
        return (builder: Builder) => {
          storeEither<StateInit, StateInit>(
            arg,
            storeStateInit,
            (arg: StateInit) => {
              return (builder: Builder) => {
...
export function loadMessageRelaxed<X>(
  slice: Slice,
  loadX: (slice: Slice) => X
): MessageRelaxed<X> {
...
export function storeMessageRelaxed<X>(
  messageRelaxed: MessageRelaxed<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function storeMessageAny(
...
export function loadIntermediateAddress(slice: Slice): IntermediateAddress {
  ...
  throw new Error(
    'Expected one of "IntermediateAddress_interm_addr_regular", "IntermediateAddress_interm_addr_simple", "IntermediateAddress_interm_addr_ext" in loading "IntermediateAddress", but data does not satisfy any constructor'
  );
}

export function storeIntermediateAddress(
...
export function loadMsgEnvelope(slice: Slice): MsgEnvelope {
  ...
  if (slice.remainingBits >= 4 && slice.preloadUint(4) == 0x5) {
    ...
    let emitted_lt: Maybe<number> = loadMaybe<number>(slice, (slice: Slice) => {
      return slice.loadUint(64);
    });
    let metadata: Maybe<MsgMetadata> = loadMaybe<MsgMetadata>(
      slice,
      loadMsgMetadata
    );
    return {
  ...
  throw new Error(
    'Expected one of "MsgEnvelope_msg_envelope", "MsgEnvelope_msg_envelope_v2" in loading "MsgEnvelope", but data does not satisfy any constructor'
  );
}

export function storeMsgEnvelope(
  ...
  if (msgEnvelope.kind == "MsgEnvelope_msg_envelope_v2") {
    return (builder: Builder) => {
      ...
      builder.storeRef(cell1);
      storeMaybe<number>(msgEnvelope.emitted_lt, (arg: number) => {
        return (builder: Builder) => {
...
export function loadMsgMetadata(slice: Slice): MsgMetadata {
  if (slice.remainingBits >= 4 && slice.preloadUint(4) == 0x0) {
    ...
    let initiator_lt: number = slice.loadUint(64);
    return {
      kind: "MsgMetadata",
      depth: depth,
  ...
  throw new Error(
    'Expected one of "MsgMetadata" in loading "MsgMetadata", but data does not satisfy any constructor'
  );
}

export function storeMsgMetadata(
...
export function loadInMsg(slice: Slice): InMsg {
  ...
  throw new Error(
    'Expected one of "InMsg_msg_import_ext", "InMsg_msg_import_ihr", "InMsg_msg_import_imm", "InMsg_msg_import_fin", "InMsg_msg_import_tr", "InMsg_msg_discard_fin", "InMsg_msg_discard_tr", "InMsg_msg_import_deferred_fin", "InMsg_msg_import_deferred_tr" in loading "InMsg", but data does not satisfy any constructor'
  );
}
...
export function storeImportFees(
...
export function loadInMsgDescr(slice: Slice): InMsgDescr {
  let anon0: Dictionary<bigint, { value: InMsg; extra: ImportFees }> =
    Dictionary.load(
      Dictionary.Keys.BigUint(256),
      {
        serialize: () => {
...
export function storeInMsgDescr(
  inMsgDescr: InMsgDescr
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeDict(inMsgDescr.anon0, Dictionary.Keys.BigUint(256), {
      serialize: (
        arg: { value: InMsg; extra: ImportFees },
        builder: Builder
      ) => {
        ((arg: ImportFees) => {
          return (builder: Builder) => {
...
export function storeEnqueuedMsg(
  enqueuedMsg: EnqueuedMsg
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadOutMsgDescr(slice: Slice): OutMsgDescr {
  let anon0: Dictionary<bigint, { value: OutMsg; extra: CurrencyCollection }> =
    Dictionary.load(
      Dictionary.Keys.BigUint(256),
      {
        serialize: () => {
...
export function storeOutMsgDescr(
  outMsgDescr: OutMsgDescr
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeDict(outMsgDescr.anon0, Dictionary.Keys.BigUint(256), {
      serialize: (
        arg: { value: OutMsg; extra: CurrencyCollection },
        builder: Builder
      ) => {
...
export function loadOutMsgQueue(slice: Slice): OutMsgQueue {
  let anon0: Dictionary<bigint, { value: EnqueuedMsg; extra: number }> =
    Dictionary.load(
      Dictionary.Keys.BigUint(352),
      {
        serialize: () => {
          throw new Error("Not implemented");
        },
...
export function storeProcessedUpto(
...
export function loadProcessedInfo(slice: Slice): ProcessedInfo {
  let anon0: Dictionary<bigint, ProcessedUpto> = Dictionary.load(
    Dictionary.Keys.BigUint(96),
    {
      serialize: () => {
        throw new Error("Not implemented");
      },
...
export function storeProcessedInfo(
...
export function storeIhrPendingSince(
  ihrPendingSince: IhrPendingSince
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadIhrPendingInfo(slice: Slice): IhrPendingInfo {
  let anon0: Dictionary<bigint, IhrPendingSince> = Dictionary.load(
    Dictionary.Keys.BigUint(320),
    {
      serialize: () => {
        throw new Error("Not implemented");
      },
...
export function storeIhrPendingInfo(
  ihrPendingInfo: IhrPendingInfo
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadAccountDispatchQueue(slice: Slice): AccountDispatchQueue {
  let messages: Dictionary<number, EnqueuedMsg> = Dictionary.load(
  ...
  let count: number = slice.loadUint(48);
  return {
...
export function storeAccountDispatchQueue(
  accountDispatchQueue: AccountDispatchQueue
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeDict(accountDispatchQueue.messages, Dictionary.Keys.Uint(64), {
...
export function storeDispatchQueue(
  dispatchQueue: DispatchQueue
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeDict(dispatchQueue.anon0, Dictionary.Keys.BigUint(256), {
      serialize: (
        arg: { value: AccountDispatchQueue; extra: number },
        builder: Builder
      ) => {
        ((arg: number) => {
          return (builder: Builder) => {
...
export function loadOutMsgQueueExtra(slice: Slice): OutMsgQueueExtra {
  if (slice.remainingBits >= 4 && slice.preloadUint(4) == 0x0) {
    ...
    let out_queue_size: Maybe<number> = loadMaybe<number>(
      slice,
      (slice: Slice) => {
        return slice.loadUint(48);
      }
    );
    return {
  ...
  throw new Error(
    'Expected one of "OutMsgQueueExtra" in loading "OutMsgQueueExtra", but data does not satisfy any constructor'
  );
}

export function storeOutMsgQueueExtra(
  outMsgQueueExtra: OutMsgQueueExtra
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeUint(0x0, 4);
    storeDispatchQueue(outMsgQueueExtra.dispatch_queue)(builder);
    storeMaybe<number>(outMsgQueueExtra.out_queue_size, (arg: number) => {
      return (builder: Builder) => {
...
export function loadOutMsgQueueInfo(slice: Slice): OutMsgQueueInfo {
  ...
  let extra: Maybe<OutMsgQueueExtra> = loadMaybe<OutMsgQueueExtra>(
    slice,
...
export function storeOutMsgQueueInfo(
  ...
  return (builder: Builder) => {
    ...
    storeMaybe<OutMsgQueueExtra>(
      outMsgQueueInfo.extra,
      storeOutMsgQueueExtra
    )(builder);
  };
}
...
export function storeStorageUsed(
...
export function storeStorageUsedShort(
...
export function storeStorageInfo(
...
export function loadAccount(slice: Slice): Account {
  ...
  throw new Error(
    'Expected one of "Account_account_none", "Account_account" in loading "Account", but data does not satisfy any constructor'
  );
}
...
export function storeAccountStorage(
...
export function loadAccountState(slice: Slice): AccountState {
  ...
  throw new Error(
    'Expected one of "AccountState_account_uninit", "AccountState_account_active", "AccountState_account_frozen" in loading "AccountState", but data does not satisfy any constructor'
  );
}

export function storeAccountState(
...
export function loadAccountStatus(slice: Slice): AccountStatus {
  ...
  throw new Error(
    'Expected one of "AccountStatus_acc_state_uninit", "AccountStatus_acc_state_frozen", "AccountStatus_acc_state_active", "AccountStatus_acc_state_nonexist" in loading "AccountStatus", but data does not satisfy any constructor'
  );
}

export function storeAccountStatus(
...
export function storeShardAccount(
...
export function storeDepthBalanceInfo(
...
export function loadTransaction(slice: Slice): Transaction {
  if (slice.remainingBits >= 4 && slice.preloadUint(4) == 0b0111) {
    ...
    let slice1 = slice.loadRef().beginParse(true);
    let in_msg: Maybe<Message<Cell>> = loadMaybe<Message<Cell>>(
      slice1,
      (slice: Slice) => {
        let slice1 = slice.loadRef().beginParse(true);
    ...
    let out_msgs: Dictionary<number, Message<Cell>> = Dictionary.load(
    ...
    let slice2 = slice.loadRef().beginParse(true);
    let state_update: HASH_UPDATE<Account> = loadHASH_UPDATE<Account>(
      slice2,
      loadAccount
    );
    let slice3 = slice.loadRef().beginParse(true);
  ...
  throw new Error(
    'Expected one of "Transaction" in loading "Transaction", but data does not satisfy any constructor'
  );
}
...
export function loadMERKLE_UPDATE<X>(
  slice: Slice,
  loadX: (slice: Slice) => X
): MERKLE_UPDATE<X> {
  ...
  throw new Error(
    'Expected one of "MERKLE_UPDATE" in loading "MERKLE_UPDATE", but data does not satisfy any constructor'
  );
}

export function storeMERKLE_UPDATE<X>(
  mERKLE_UPDATE: MERKLE_UPDATE<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadHASH_UPDATE<X>(
  slice: Slice,
  loadX: (slice: Slice) => X
): HASH_UPDATE<X> {
  ...
  throw new Error(
    'Expected one of "HASH_UPDATE" in loading "HASH_UPDATE", but data does not satisfy any constructor'
  );
}

export function storeHASH_UPDATE<X>(
  hASH_UPDATE: HASH_UPDATE<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadMERKLE_PROOF<X>(
  slice: Slice,
  loadX: (slice: Slice) => X
): MERKLE_PROOF<X> {
  ...
  throw new Error(
    'Expected one of "MERKLE_PROOF" in loading "MERKLE_PROOF", but data does not satisfy any constructor'
  );
}

export function storeMERKLE_PROOF<X>(
  mERKLE_PROOF: MERKLE_PROOF<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadAccountBlock(slice: Slice): AccountBlock {
  if (slice.remainingBits >= 4 && slice.preloadUint(4) == 0x5) {
    slice.loadUint(4);
    let account_addr: BitString = slice.loadBits(256);
    let transactions: HashmapAug<Transaction, CurrencyCollection> =
      loadHashmapAug<Transaction, CurrencyCollection>(
        slice,
        64,
        (slice: Slice) => {
          let slice1 = slice.loadRef().beginParse(true);
  ...
  throw new Error(
    'Expected one of "AccountBlock" in loading "AccountBlock", but data does not satisfy any constructor'
  );
}

export function storeAccountBlock(
  accountBlock: AccountBlock
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeUint(0x5, 4);
    builder.storeBits(accountBlock.account_addr);
    storeHashmapAug<Transaction, CurrencyCollection>(
...
export function loadTrStoragePhase(slice: Slice): TrStoragePhase {
  ...
  let storage_fees_due: Maybe<bigint> = loadMaybe<bigint>(
    slice,
    (slice: Slice) => {
      return slice.loadCoins();
    }
...
export function storeTrStoragePhase(
...
export function loadAccStatusChange(slice: Slice): AccStatusChange {
  ...
  throw new Error(
    'Expected one of "AccStatusChange_acst_unchanged", "AccStatusChange_acst_frozen", "AccStatusChange_acst_deleted" in loading "AccStatusChange", but data does not satisfy any constructor'
  );
}

export function storeAccStatusChange(
...
export function loadTrCreditPhase(slice: Slice): TrCreditPhase {
  let due_fees_collected: Maybe<bigint> = loadMaybe<bigint>(
    slice,
    (slice: Slice) => {
      return slice.loadCoins();
    }
...
export function storeTrCreditPhase(
...
export function loadTrComputePhase(slice: Slice): TrComputePhase {
  ...
  if (slice.remainingBits >= 1 && slice.preloadUint(1) == 0b1) {
    ...
    let gas_credit: Maybe<bigint> = loadMaybe<bigint>(
      slice1,
      (slice: Slice) => {
  ...
  throw new Error(
    'Expected one of "TrComputePhase_tr_phase_compute_skipped", "TrComputePhase_tr_phase_compute_vm" in loading "TrComputePhase", but data does not satisfy any constructor'
  );
}

export function storeTrComputePhase(
...
export function loadComputeSkipReason(slice: Slice): ComputeSkipReason {
  ...
  throw new Error(
    'Expected one of "ComputeSkipReason_cskip_no_state", "ComputeSkipReason_cskip_bad_state", "ComputeSkipReason_cskip_no_gas", "ComputeSkipReason_cskip_suspended" in loading "ComputeSkipReason", but data does not satisfy any constructor'
  );
}

export function storeComputeSkipReason(
...
export function loadTrActionPhase(slice: Slice): TrActionPhase {
  ...
  let status_change: AccStatusChange = loadAccStatusChange(slice);
  let total_fwd_fees: Maybe<bigint> = loadMaybe<bigint>(
    slice,
    (slice: Slice) => {
      return slice.loadCoins();
    }
  );
  let total_action_fees: Maybe<bigint> = loadMaybe<bigint>(
    slice,
    (slice: Slice) => {
      return slice.loadCoins();
    }
...
export function storeTrActionPhase(
...
export function loadTrBouncePhase(slice: Slice): TrBouncePhase {
  ...
  throw new Error(
    'Expected one of "TrBouncePhase_tr_phase_bounce_negfunds", "TrBouncePhase_tr_phase_bounce_nofunds", "TrBouncePhase_tr_phase_bounce_ok" in loading "TrBouncePhase", but data does not satisfy any constructor'
  );
}

export function storeTrBouncePhase(
...
export function loadTransactionDescr(slice: Slice): TransactionDescr {
  if (slice.remainingBits >= 4 && slice.preloadUint(4) == 0b0000) {
    ...
    let storage_ph: Maybe<TrStoragePhase> = loadMaybe<TrStoragePhase>(
      slice,
      loadTrStoragePhase
    );
    let credit_ph: Maybe<TrCreditPhase> = loadMaybe<TrCreditPhase>(
      slice,
      loadTrCreditPhase
    );
    let compute_ph: TrComputePhase = loadTrComputePhase(slice);
    let action: Maybe<TrActionPhase> = loadMaybe<TrActionPhase>(
      slice,
      (slice: Slice) => {
        let slice1 = slice.loadRef().beginParse(true);
    ...
    let bounce: Maybe<TrBouncePhase> = loadMaybe<TrBouncePhase>(
      slice,
      loadTrBouncePhase
    );
  ...
  throw new Error(
    'Expected one of "TransactionDescr_trans_ord", "TransactionDescr_trans_storage", "TransactionDescr_trans_tick_tock", "TransactionDescr_trans_split_prepare", "TransactionDescr_trans_split_install", "TransactionDescr_trans_merge_prepare", "TransactionDescr_trans_merge_install" in loading "TransactionDescr", but data does not satisfy any constructor'
  );
}

export function storeTransactionDescr(
  ...
  if (transactionDescr.kind == "TransactionDescr_trans_ord") {
    return (builder: Builder) => {
      ...
      storeMaybe<TrStoragePhase>(
        transactionDescr.storage_ph,
        storeTrStoragePhase
      )(builder);
      storeMaybe<TrCreditPhase>(
        transactionDescr.credit_ph,
        storeTrCreditPhase
      )(builder);
      storeTrComputePhase(transactionDescr.compute_ph)(builder);
      storeMaybe<TrActionPhase>(
        transactionDescr.action,
        (arg: TrActionPhase) => {
          return (builder: Builder) => {
            let cell1 = beginCell();
      ...
      storeMaybe<TrBouncePhase>(
        transactionDescr.bounce,
        storeTrBouncePhase
      )(builder);
...
export function storeSplitMergeInfo(
...
export function loadSmartContractInfo(slice: Slice): SmartContractInfo {
  ...
  throw new Error(
    'Expected one of "SmartContractInfo" in loading "SmartContractInfo", but data does not satisfy any constructor'
  );
}

export function storeSmartContractInfo(
...
export function loadOutList(slice: Slice, arg0: number): OutList {
  ...
  throw new Error(
    'Expected one of "OutList_out_list_empty", "OutList_out_list" in loading "OutList", but data does not satisfy any constructor'
  );
}
...
export function loadOutAction(slice: Slice): OutAction {
  if (slice.remainingBits >= 32 && slice.preloadUint(32) == 0x0ec3c86d) {
    ...
    let slice1 = slice.loadRef().beginParse(true);
    let out_msg: MessageRelaxed<Cell> = loadMessageRelaxed<Cell>(
      slice1,
      (slice: Slice) => {
        return slice.asCell();
      }
  ...
  throw new Error(
    'Expected one of "OutAction_action_send_msg", "OutAction_action_set_code", "OutAction_action_reserve_currency", "OutAction_action_change_library" in loading "OutAction", but data does not satisfy any constructor'
  );
}

export function storeOutAction(
  outAction: OutAction
): (builder: Builder) => void {
...
export function loadLibRef(slice: Slice): LibRef {
  ...
  throw new Error(
    'Expected one of "LibRef_libref_hash", "LibRef_libref_ref" in loading "LibRef", but data does not satisfy any constructor'
  );
}
...
export function storeOutListNode(
  outListNode: OutListNode
): (builder: Builder) => void {
  return (builder: Builder) => {
    let cell1 = beginCell();
...
export function loadShardIdent(slice: Slice): ShardIdent {
  ...
  throw new Error(
    'Expected one of "ShardIdent" in loading "ShardIdent", but data does not satisfy any constructor'
  );
}

export function storeShardIdent(
...
export function storeExtBlkRef(
  extBlkRef: ExtBlkRef
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function storeBlockIdExt(
...
export function storeBlkMasterInfo(
  blkMasterInfo: BlkMasterInfo
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadShardStateUnsplit(slice: Slice): ShardStateUnsplit {
  if (slice.remainingBits >= 32 && slice.preloadUint(32) == 0x9023afe2) {
    ...
    let total_validator_fees: CurrencyCollection =
      loadCurrencyCollection(slice3);
    let libraries: Dictionary<bigint, LibDescr> = Dictionary.load(
      Dictionary.Keys.BigUint(256),
      {
        serialize: () => {
          throw new Error("Not implemented");
    ...
    let master_ref: Maybe<BlkMasterInfo> = loadMaybe<BlkMasterInfo>(
      slice3,
      loadBlkMasterInfo
    );
    let custom: Maybe<McStateExtra> = loadMaybe<McStateExtra>(
      slice,
      (slice: Slice) => {
        let slice1 = slice.loadRef().beginParse(true);
  ...
  throw new Error(
    'Expected one of "ShardStateUnsplit" in loading "ShardStateUnsplit", but data does not satisfy any constructor'
  );
}

export function storeShardStateUnsplit(
  ...
  return (builder: Builder) => {
    ...
    storeMaybe<BlkMasterInfo>(
      shardStateUnsplit.master_ref,
      storeBlkMasterInfo
    )(cell3);
    builder.storeRef(cell3);
...
export function loadShardState(slice: Slice): ShardState {
  ...
  throw new Error(
    'Expected one of "ShardState_split_state", "ShardState__" in loading "ShardState", but data does not satisfy any constructor'
  );
}

export function storeShardState(
...
export function loadLibDescr(slice: Slice): LibDescr {
  ...
  throw new Error(
    'Expected one of "LibDescr" in loading "LibDescr", but data does not satisfy any constructor'
  );
}
...
export function loadBlockInfo(slice: Slice): BlockInfo {
  if (slice.remainingBits >= 32 && slice.preloadUint(32) == 0x9bc7a987) {
    ...
    let gen_software: GlobalVersion | undefined =
      flags & (1 << 0) ? loadGlobalVersion(slice) : undefined;
    ...
    if (!(flags <= 1)) {
      throw new Error(
        'Condition (flags <= 1) is not satisfied while loading "BlockInfo" for type "BlockInfo"'
      );
    }
  ...
  throw new Error(
    'Expected one of "BlockInfo" in loading "BlockInfo", but data does not satisfy any constructor'
  );
}

export function storeBlockInfo(
  blockInfo: BlockInfo
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function storeBlkPrevInfo(
  blkPrevInfo: BlkPrevInfo
): (builder: Builder) => void {
...
export function loadBlock(slice: Slice): Block {
  ...
  throw new Error(
    'Expected one of "Block" in loading "Block", but data does not satisfy any constructor'
  );
}
...
export function loadBlockExtra(slice: Slice): BlockExtra {
  if (slice.remainingBits >= 32 && slice.preloadUint(32) == 0x4a33f6fd) {
    ...
    let custom: Maybe<McBlockExtra> = loadMaybe<McBlockExtra>(
      slice,
      (slice: Slice) => {
        let slice1 = slice.loadRef().beginParse(true);
  ...
  throw new Error(
    'Expected one of "BlockExtra" in loading "BlockExtra", but data does not satisfy any constructor'
  );
}

export function storeBlockExtra(
...
export function loadValueFlow(slice: Slice): ValueFlow {
  ...
  throw new Error(
    'Expected one of "ValueFlow_value_flow", "ValueFlow_value_flow_v2" in loading "ValueFlow", but data does not satisfy any constructor'
  );
}

export function storeValueFlow(
  valueFlow: ValueFlow
): (builder: Builder) => void {
...
export function loadBinTree<X>(
  ...
  throw new Error(
    'Expected one of "BinTree_bt_leaf", "BinTree_bt_fork" in loading "BinTree", but data does not satisfy any constructor'
  );
}

export function storeBinTree<X>(
  binTree: BinTree<X>,
  storeX: (x: X) => (builder: Builder) => void
): (builder: Builder) => void {
...
export function loadFutureSplitMerge(slice: Slice): FutureSplitMerge {
  ...
  throw new Error(
    'Expected one of "FutureSplitMerge_fsm_none", "FutureSplitMerge_fsm_split", "FutureSplitMerge_fsm_merge" in loading "FutureSplitMerge", but data does not satisfy any constructor'
  );
}

export function storeFutureSplitMerge(
  futureSplitMerge: FutureSplitMerge
): (builder: Builder) => void {
...
export function loadShardDescr(slice: Slice): ShardDescr {
  if (slice.remainingBits >= 4 && slice.preloadUint(4) == 0xb) {
    ...
    if (!(flags == 0)) {
      throw new Error(
        'Condition (flags == 0) is not satisfied while loading "ShardDescr_shard_descr" for type "ShardDescr"'
      );
    }
    return {
  ...
  if (slice.remainingBits >= 4 && slice.preloadUint(4) == 0xa) {
    ...
    if (!(flags == 0)) {
      throw new Error(
        'Condition (flags == 0) is not satisfied while loading "ShardDescr_shard_descr_new" for type "ShardDescr"'
      );
    }
    return {
  ...
  throw new Error(
    'Expected one of "ShardDescr_shard_descr", "ShardDescr_shard_descr_new" in loading "ShardDescr", but data does not satisfy any constructor'
  );
}

export function storeShardDescr(
  ...
  if (shardDescr.kind == "ShardDescr_shard_descr") {
    return (builder: Builder) => {
      ...
      if (!(shardDescr.flags == 0)) {
        throw new Error(
          'Condition (shardDescr.flags == 0) is not satisfied while loading "ShardDescr_shard_descr" for type "ShardDescr"'
        );
      }
    };
  }
  if (shardDescr.kind == "ShardDescr_shard_descr_new") {
    return (builder: Builder) => {
      ...
      if (!(shardDescr.flags == 0)) {
        throw new Error(
          'Condition (shardDescr.flags == 0) is not satisfied while loading "ShardDescr_shard_descr_new" for type "ShardDescr"'
        );
      }
    };
  }
...
export function loadShardHashes(slice: Slice): ShardHashes {
  let anon0: Dictionary<number, BinTree<ShardDescr>> = Dictionary.load(
    Dictionary.Keys.Uint(32),
    {
      serialize: () => {
        throw new Error("Not implemented");
...
export function storeShardHashes(
...
export function loadBinTreeAug<X, Y>(
  slice: Slice,
  loadX: (slice: Slice) => X,
  loadY: (slice: Slice) => Y
): BinTreeAug<X, Y> {
  ...
  throw new Error(
    'Expected one of "BinTreeAug_bta_leaf", "BinTreeAug_bta_fork" in loading "BinTreeAug", but data does not satisfy any constructor'
  );
}

export function storeBinTreeAug<X, Y>(
  binTreeAug: BinTreeAug<X, Y>,
  storeX: (x: X) => (builder: Builder) => void,
  storeY: (y: Y) => (builder: Builder) => void
): (builder: Builder) => void {
...
export function storeShardFeeCreated(
  shardFeeCreated: ShardFeeCreated
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function storeShardFees(
  shardFees: ShardFees
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeDict(shardFees.anon0, Dictionary.Keys.BigUint(96), {
      serialize: (
        arg: { value: ShardFeeCreated; extra: ShardFeeCreated },
        builder: Builder
      ) => {
        ((arg: ShardFeeCreated) => {
          return (builder: Builder) => {
...
export function storeConfigParams(
...
export function storeValidatorInfo(
...
export function storeValidatorBaseInfo(
...
export function storeKeyExtBlkRef(
  keyExtBlkRef: KeyExtBlkRef
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadOldMcBlocksInfo(slice: Slice): OldMcBlocksInfo {
  let anon0: Dictionary<number, { value: KeyExtBlkRef; extra: KeyMaxLt }> =
    Dictionary.load(
      Dictionary.Keys.Uint(32),
      {
        serialize: () => {
...
export function storeOldMcBlocksInfo(
  oldMcBlocksInfo: OldMcBlocksInfo
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeDict(oldMcBlocksInfo.anon0, Dictionary.Keys.Uint(32), {
      serialize: (
        arg: { value: KeyExtBlkRef; extra: KeyMaxLt },
        builder: Builder
      ) => {
        ((arg: KeyMaxLt) => {
          return (builder: Builder) => {
...
export function loadCreatorStats(slice: Slice): CreatorStats {
  ...
  throw new Error(
    'Expected one of "CreatorStats" in loading "CreatorStats", but data does not satisfy any constructor'
  );
}

export function storeCreatorStats(
...
export function loadBlockCreateStats(slice: Slice): BlockCreateStats {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0x17) {
    slice.loadUint(8);
    let counters: Dictionary<bigint, CreatorStats> = Dictionary.load(
      Dictionary.Keys.BigUint(256),
      {
        serialize: () => {
          throw new Error("Not implemented");
  ...
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0x34) {
    slice.loadUint(8);
    let counters: Dictionary<bigint, { value: CreatorStats; extra: number }> =
      Dictionary.load(
        Dictionary.Keys.BigUint(256),
        {
          serialize: () => {
  ...
  throw new Error(
    'Expected one of "BlockCreateStats_block_create_stats", "BlockCreateStats_block_create_stats_ext" in loading "BlockCreateStats", but data does not satisfy any constructor'
  );
}

export function storeBlockCreateStats(
  ...
  if (blockCreateStats.kind == "BlockCreateStats_block_create_stats_ext") {
    return (builder: Builder) => {
      ...
      builder.storeDict(
        ...
        {
          serialize: (
            arg: { value: CreatorStats; extra: number },
            builder: Builder
          ) => {
            ((arg: number) => {
              return (builder: Builder) => {
...
export function loadMcStateExtra(slice: Slice): McStateExtra {
  if (slice.remainingBits >= 16 && slice.preloadUint(16) == 0xcc26) {
    ...
    let last_key_block: Maybe<ExtBlkRef> = loadMaybe<ExtBlkRef>(
      slice1,
      loadExtBlkRef
    );
    let block_create_stats: BlockCreateStats | undefined =
      flags & (1 << 0) ? loadBlockCreateStats(slice1) : undefined;
  ...
  throw new Error(
    'Expected one of "McStateExtra" in loading "McStateExtra", but data does not satisfy any constructor'
  );
}
...
export function loadSigPubKey(slice: Slice): SigPubKey {
  ...
  throw new Error(
    'Expected one of "SigPubKey" in loading "SigPubKey", but data does not satisfy any constructor'
  );
}

export function storeSigPubKey(
  sigPubKey: SigPubKey
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadCryptoSignatureSimple(slice: Slice): CryptoSignatureSimple {
  ...
  throw new Error(
    'Expected one of "CryptoSignatureSimple" in loading "CryptoSignatureSimple", but data does not satisfy any constructor'
  );
}

export function storeCryptoSignatureSimple(
  cryptoSignatureSimple: CryptoSignatureSimple
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeUint(0x5, 4);
...
export function loadCryptoSignature(slice: Slice): CryptoSignature {
  if (slice.remainingBits >= 4 && slice.preloadUint(4) == 0xf) {
    ...
    let temp_key_signature: CryptoSignatureSimple =
      loadCryptoSignatureSimple(slice);
    return {
  ...
  throw new Error(
    'Expected one of "CryptoSignature_chained_signature", "CryptoSignature__" in loading "CryptoSignature", but data does not satisfy any constructor'
  );
}

export function storeCryptoSignature(
...
export function storeCryptoSignaturePair(
  cryptoSignaturePair: CryptoSignaturePair
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadCertificate(slice: Slice): Certificate {
  ...
  throw new Error(
    'Expected one of "Certificate" in loading "Certificate", but data does not satisfy any constructor'
  );
}
...
export function loadCertificateEnv(slice: Slice): CertificateEnv {
  ...
  throw new Error(
    'Expected one of "CertificateEnv" in loading "CertificateEnv", but data does not satisfy any constructor'
  );
}

export function storeCertificateEnv(
...
export function storeSignedCertificate(
...
export function loadMcBlockExtra(slice: Slice): McBlockExtra {
  if (slice.remainingBits >= 16 && slice.preloadUint(16) == 0xcca5) {
    ...
    let slice1 = slice.loadRef().beginParse(true);
    let prev_blk_signatures: Dictionary<number, CryptoSignaturePair> =
      Dictionary.load(
    ...
    let recover_create_msg: Maybe<InMsg> = loadMaybe<InMsg>(
      slice1,
      (slice: Slice) => {
        let slice1 = slice.loadRef().beginParse(true);
    ...
    let config: ConfigParams | undefined = key_block
      ? loadConfigParams(slice)
      : undefined;
    return {
      kind: "McBlockExtra",
      key_block: key_block,
  ...
  throw new Error(
    'Expected one of "McBlockExtra" in loading "McBlockExtra", but data does not satisfy any constructor'
  );
}

export function storeMcBlockExtra(
  ...
  return (builder: Builder) => {
    ...
    let cell1 = beginCell();
    cell1.storeDict(
      mcBlockExtra.prev_blk_signatures,
      Dictionary.Keys.Uint(16),
      {
...
export function loadValidatorDescr(slice: Slice): ValidatorDescr {
  ...
  throw new Error(
    'Expected one of "ValidatorDescr_validator", "ValidatorDescr_validator_addr" in loading "ValidatorDescr", but data does not satisfy any constructor'
  );
}

export function storeValidatorDescr(
  validatorDescr: ValidatorDescr
): (builder: Builder) => void {
...
export function loadValidatorSet(slice: Slice): ValidatorSet {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0x11) {
    ...
    let list: Hashmap<ValidatorDescr> = loadHashmap<ValidatorDescr>(
      slice,
      16,
      loadValidatorDescr
    );
    if (!(main <= total)) {
      throw new Error(
        'Condition (main <= total) is not satisfied while loading "ValidatorSet_validators" for type "ValidatorSet"'
      );
    }
    if (!(main >= 1)) {
      throw new Error(
        'Condition (main >= 1) is not satisfied while loading "ValidatorSet_validators" for type "ValidatorSet"'
      );
    }
    return {
  ...
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0x12) {
    ...
    let list: Dictionary<number, ValidatorDescr> = Dictionary.load(
      Dictionary.Keys.Uint(16),
      {
        serialize: () => {
          throw new Error("Not implemented");
    ...
    if (!(main <= total)) {
      throw new Error(
        'Condition (main <= total) is not satisfied while loading "ValidatorSet_validators_ext" for type "ValidatorSet"'
      );
    }
    if (!(main >= 1)) {
      throw new Error(
        'Condition (main >= 1) is not satisfied while loading "ValidatorSet_validators_ext" for type "ValidatorSet"'
      );
    }
    return {
  ...
  throw new Error(
    'Expected one of "ValidatorSet_validators", "ValidatorSet_validators_ext" in loading "ValidatorSet", but data does not satisfy any constructor'
  );
}
...
export function storeValidatorSet(
  ...
  if (validatorSet.kind == "ValidatorSet_validators") {
    return (builder: Builder) => {
      ...
      storeHashmap<ValidatorDescr>(
        validatorSet.list,
        storeValidatorDescr
      )(builder);
      if (!(validatorSet.main <= validatorSet.total)) {
        throw new Error(
          'Condition (validatorSet.main <= validatorSet.total) is not satisfied while loading "ValidatorSet_validators" for type "ValidatorSet"'
        );
      }
      if (!(validatorSet.main >= 1)) {
        throw new Error(
          'Condition (validatorSet.main >= 1) is not satisfied while loading "ValidatorSet_validators" for type "ValidatorSet"'
        );
      }
    };
  }
  if (validatorSet.kind == "ValidatorSet_validators_ext") {
    return (builder: Builder) => {
      ...
      if (!(validatorSet.main <= validatorSet.total)) {
        throw new Error(
          'Condition (validatorSet.main <= validatorSet.total) is not satisfied while loading "ValidatorSet_validators_ext" for type "ValidatorSet"'
        );
      }
      if (!(validatorSet.main >= 1)) {
        throw new Error(
          'Condition (validatorSet.main >= 1) is not satisfied while loading "ValidatorSet_validators_ext" for type "ValidatorSet"'
        );
      }
    };
  }
...
export function loadConfigParam(slice: Slice, arg0: number): ConfigParam {
  ...
  if (arg0 == 9) {
    let mandatory_params: Hashmap<True> = loadHashmap<True>(
      slice,
      32,
      loadTrue
    );
  ...
  if (arg0 == 12) {
    let workchains: Dictionary<number, WorkchainDescr> = Dictionary.load(
      Dictionary.Keys.Uint(32),
      {
        serialize: () => {
          throw new Error("Not implemented");
  ...
  if (arg0 == 16) {
    ...
    if (!(max_validators >= max_main_validators)) {
      throw new Error(
        'Condition (max_validators >= max_main_validators) is not satisfied while loading "ConfigParam__16" for type "ConfigParam"'
      );
    }
    if (!(max_main_validators >= min_validators)) {
      throw new Error(
        'Condition (max_main_validators >= min_validators) is not satisfied while loading "ConfigParam__16" for type "ConfigParam"'
      );
    }
    if (!(min_validators >= 1)) {
      throw new Error(
        'Condition (min_validators >= 1) is not satisfied while loading "ConfigParam__16" for type "ConfigParam"'
      );
    }
    return {
  ...
  if (arg0 == 18) {
    let anon0: Hashmap<StoragePrices> = loadHashmap<StoragePrices>(
      slice,
      32,
      loadStoragePrices
    );
  ...
  if (arg0 == 31) {
    let fundamental_smc_addr: Dictionary<bigint, True> = Dictionary.load(
      Dictionary.Keys.BigUint(256),
      {
        serialize: () => {
          throw new Error("Not implemented");
  ...
  if (arg0 == 39) {
    let anon0: Dictionary<bigint, ValidatorSignedTempKey> = Dictionary.load(
      Dictionary.Keys.BigUint(256),
      {
        serialize: () => {
          throw new Error("Not implemented");
  ...
  if (arg0 == 40) {
    let anon0: MisbehaviourPunishmentConfig =
      loadMisbehaviourPunishmentConfig(slice);
    return {
  ...
  if (arg0 == 45) {
    let anon0: PrecompiledContractsConfig =
      loadPrecompiledContractsConfig(slice);
    return {
...
export function storeConfigParam(
  ...
  if (configParam.kind == "ConfigParam__16") {
    return (builder: Builder) => {
      ...
      if (!(configParam.max_validators >= configParam.max_main_validators)) {
        throw new Error(
          'Condition (configParam.max_validators >= configParam.max_main_validators) is not satisfied while loading "ConfigParam__16" for type "ConfigParam"'
        );
      }
      if (!(configParam.max_main_validators >= configParam.min_validators)) {
        throw new Error(
          'Condition (configParam.max_main_validators >= configParam.min_validators) is not satisfied while loading "ConfigParam__16" for type "ConfigParam"'
        );
      }
      if (!(configParam.min_validators >= 1)) {
        throw new Error(
          'Condition (configParam.min_validators >= 1) is not satisfied while loading "ConfigParam__16" for type "ConfigParam"'
        );
      }
    };
  }
  ...
  if (configParam.kind == "ConfigParam__28") {
    return (builder: Builder) => {
      builder.storeDict(
        configParam.fundamental_smc_addr,
        Dictionary.Keys.BigUint(256),
        {
...
export function loadBurningConfig(slice: Slice): BurningConfig {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0x01) {
    slice.loadUint(8);
    let blackhole_addr: Maybe<BitString> = loadMaybe<BitString>(
      slice,
      (slice: Slice) => {
    ...
    if (!(fee_burn_num <= fee_burn_denom)) {
      throw new Error(
        'Condition (fee_burn_num <= fee_burn_denom) is not satisfied while loading "BurningConfig" for type "BurningConfig"'
      );
    }
    if (!(fee_burn_denom >= 1)) {
      throw new Error(
        'Condition (fee_burn_denom >= 1) is not satisfied while loading "BurningConfig" for type "BurningConfig"'
      );
    }
    return {
      kind: "BurningConfig",
  ...
  throw new Error(
    'Expected one of "BurningConfig" in loading "BurningConfig", but data does not satisfy any constructor'
  );
}

export function storeBurningConfig(
  ...
  return (builder: Builder) => {
    ...
    if (!(burningConfig.fee_burn_num <= burningConfig.fee_burn_denom)) {
      throw new Error(
        'Condition (burningConfig.fee_burn_num <= burningConfig.fee_burn_denom) is not satisfied while loading "BurningConfig" for type "BurningConfig"'
      );
    }
    if (!(burningConfig.fee_burn_denom >= 1)) {
      throw new Error(
        'Condition (burningConfig.fee_burn_denom >= 1) is not satisfied while loading "BurningConfig" for type "BurningConfig"'
      );
    }
  };
}
...
export function storeGlobalVersion(
...
export function loadConfigProposalSetup(slice: Slice): ConfigProposalSetup {
  ...
  throw new Error(
    'Expected one of "ConfigProposalSetup" in loading "ConfigProposalSetup", but data does not satisfy any constructor'
  );
}

export function storeConfigProposalSetup(
...
export function loadConfigVotingSetup(slice: Slice): ConfigVotingSetup {
  ...
  throw new Error(
    'Expected one of "ConfigVotingSetup" in loading "ConfigVotingSetup", but data does not satisfy any constructor'
  );
}

export function storeConfigVotingSetup(
...
export function loadConfigProposal(slice: Slice): ConfigProposal {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xf3) {
    ...
    let if_hash_equal: Maybe<bigint> = loadMaybe<bigint>(
      slice,
      (slice: Slice) => {
  ...
  throw new Error(
    'Expected one of "ConfigProposal" in loading "ConfigProposal", but data does not satisfy any constructor'
  );
}
...
export function loadConfigProposalStatus(slice: Slice): ConfigProposalStatus {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xce) {
    ...
    let voters: Dictionary<number, True> = Dictionary.load(
      Dictionary.Keys.Uint(16),
      {
        serialize: () => {
          throw new Error("Not implemented");
  ...
  throw new Error(
    'Expected one of "ConfigProposalStatus" in loading "ConfigProposalStatus", but data does not satisfy any constructor'
  );
}

export function storeConfigProposalStatus(
  configProposalStatus: ConfigProposalStatus
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadWorkchainFormat(
  slice: Slice,
  arg0: number
): WorkchainFormat {
  ...
  if (slice.remainingBits >= 4 && slice.preloadUint(4) == 0x0 && arg0 == 0) {
    ...
    if (!(min_addr_len >= 64)) {
      throw new Error(
        'Condition (min_addr_len >= 64) is not satisfied while loading "WorkchainFormat_wfmt_ext" for type "WorkchainFormat"'
      );
    }
    if (!(min_addr_len <= max_addr_len)) {
      throw new Error(
        'Condition (min_addr_len <= max_addr_len) is not satisfied while loading "WorkchainFormat_wfmt_ext" for type "WorkchainFormat"'
      );
    }
    if (!(max_addr_len <= 1023)) {
      throw new Error(
        'Condition (max_addr_len <= 1023) is not satisfied while loading "WorkchainFormat_wfmt_ext" for type "WorkchainFormat"'
      );
    }
    if (!(addr_len_step <= 1023)) {
      throw new Error(
        'Condition (addr_len_step <= 1023) is not satisfied while loading "WorkchainFormat_wfmt_ext" for type "WorkchainFormat"'
      );
    }
    if (!(workchain_type_id >= 1)) {
      throw new Error(
        'Condition (workchain_type_id >= 1) is not satisfied while loading "WorkchainFormat_wfmt_ext" for type "WorkchainFormat"'
      );
    }
    return {
  ...
  throw new Error(
    'Expected one of "WorkchainFormat_wfmt_basic", "WorkchainFormat_wfmt_ext" in loading "WorkchainFormat", but data does not satisfy any constructor'
  );
}

export function storeWorkchainFormat(
  workchainFormat: WorkchainFormat
): (builder: Builder) => void {
  ...
  if (workchainFormat.kind == "WorkchainFormat_wfmt_ext") {
    return (builder: Builder) => {
      ...
      if (!(workchainFormat.min_addr_len >= 64)) {
        throw new Error(
          'Condition (workchainFormat.min_addr_len >= 64) is not satisfied while loading "WorkchainFormat_wfmt_ext" for type "WorkchainFormat"'
        );
      }
      if (!(workchainFormat.min_addr_len <= workchainFormat.max_addr_len)) {
        throw new Error(
          'Condition (workchainFormat.min_addr_len <= workchainFormat.max_addr_len) is not satisfied while loading "WorkchainFormat_wfmt_ext" for type "WorkchainFormat"'
        );
      }
      if (!(workchainFormat.max_addr_len <= 1023)) {
        throw new Error(
          'Condition (workchainFormat.max_addr_len <= 1023) is not satisfied while loading "WorkchainFormat_wfmt_ext" for type "WorkchainFormat"'
        );
      }
      if (!(workchainFormat.addr_len_step <= 1023)) {
        throw new Error(
          'Condition (workchainFormat.addr_len_step <= 1023) is not satisfied while loading "WorkchainFormat_wfmt_ext" for type "WorkchainFormat"'
        );
      }
      if (!(workchainFormat.workchain_type_id >= 1)) {
        throw new Error(
          'Condition (workchainFormat.workchain_type_id >= 1) is not satisfied while loading "WorkchainFormat_wfmt_ext" for type "WorkchainFormat"'
        );
      }
    };
  }
...
export function loadWcSplitMergeTimings(slice: Slice): WcSplitMergeTimings {
  ...
  throw new Error(
    'Expected one of "WcSplitMergeTimings" in loading "WcSplitMergeTimings", but data does not satisfy any constructor'
  );
}

export function storeWcSplitMergeTimings(
...
export function loadWorkchainDescr(slice: Slice): WorkchainDescr {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xa6) {
    ...
    if (!(monitor_min_split <= min_split)) {
      throw new Error(
        'Condition (monitor_min_split <= min_split) is not satisfied while loading "WorkchainDescr_workchain" for type "WorkchainDescr"'
      );
    }
    if (!(flags == 0)) {
      throw new Error(
        'Condition (flags == 0) is not satisfied while loading "WorkchainDescr_workchain" for type "WorkchainDescr"'
      );
    }
    return {
  ...
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xa7) {
    ...
    let version: number = slice.loadUint(32);
    let format: WorkchainFormat = loadWorkchainFormat(slice, basic);
    let split_merge_timings: WcSplitMergeTimings =
      loadWcSplitMergeTimings(slice);
    if (!(monitor_min_split <= min_split)) {
      throw new Error(
        'Condition (monitor_min_split <= min_split) is not satisfied while loading "WorkchainDescr_workchain_v2" for type "WorkchainDescr"'
      );
    }
    if (!(flags == 0)) {
      throw new Error(
        'Condition (flags == 0) is not satisfied while loading "WorkchainDescr_workchain_v2" for type "WorkchainDescr"'
      );
    }
    return {
  ...
  throw new Error(
    'Expected one of "WorkchainDescr_workchain", "WorkchainDescr_workchain_v2" in loading "WorkchainDescr", but data does not satisfy any constructor'
  );
}

export function storeWorkchainDescr(
  ...
  if (workchainDescr.kind == "WorkchainDescr_workchain") {
    return (builder: Builder) => {
      ...
      if (!(workchainDescr.monitor_min_split <= workchainDescr.min_split)) {
        throw new Error(
          'Condition (workchainDescr.monitor_min_split <= workchainDescr.min_split) is not satisfied while loading "WorkchainDescr_workchain" for type "WorkchainDescr"'
        );
      }
      if (!(workchainDescr.flags == 0)) {
        throw new Error(
          'Condition (workchainDescr.flags == 0) is not satisfied while loading "WorkchainDescr_workchain" for type "WorkchainDescr"'
        );
      }
    };
  }
  if (workchainDescr.kind == "WorkchainDescr_workchain_v2") {
    return (builder: Builder) => {
      ...
      if (!(workchainDescr.monitor_min_split <= workchainDescr.min_split)) {
        throw new Error(
          'Condition (workchainDescr.monitor_min_split <= workchainDescr.min_split) is not satisfied while loading "WorkchainDescr_workchain_v2" for type "WorkchainDescr"'
        );
      }
      if (!(workchainDescr.flags == 0)) {
        throw new Error(
          'Condition (workchainDescr.flags == 0) is not satisfied while loading "WorkchainDescr_workchain_v2" for type "WorkchainDescr"'
        );
      }
    };
  }
...
export function loadComplaintPricing(slice: Slice): ComplaintPricing {
  ...
  throw new Error(
    'Expected one of "ComplaintPricing" in loading "ComplaintPricing", but data does not satisfy any constructor'
  );
}

export function storeComplaintPricing(
...
export function loadBlockCreateFees(slice: Slice): BlockCreateFees {
  ...
  throw new Error(
    'Expected one of "BlockCreateFees" in loading "BlockCreateFees", but data does not satisfy any constructor'
  );
}

export function storeBlockCreateFees(
...
export function loadStoragePrices(slice: Slice): StoragePrices {
  ...
  throw new Error(
    'Expected one of "StoragePrices" in loading "StoragePrices", but data does not satisfy any constructor'
  );
}

export function storeStoragePrices(
...
export function loadGasLimitsPrices(slice: Slice): GasLimitsPrices {
  ...
  throw new Error(
    'Expected one of "GasLimitsPrices_gas_prices", "GasLimitsPrices_gas_prices_ext", "GasLimitsPrices_gas_flat_pfx" in loading "GasLimitsPrices", but data does not satisfy any constructor'
  );
}

export function storeGasLimitsPrices(
...
export function loadParamLimits(slice: Slice): ParamLimits {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xc3) {
    ...
    if (!(underload <= soft_limit)) {
      throw new Error(
        'Condition (underload <= soft_limit) is not satisfied while loading "ParamLimits" for type "ParamLimits"'
      );
    }
    if (!(soft_limit <= hard_limit)) {
      throw new Error(
        'Condition (soft_limit <= hard_limit) is not satisfied while loading "ParamLimits" for type "ParamLimits"'
      );
    }
    return {
      kind: "ParamLimits",
  ...
  throw new Error(
    'Expected one of "ParamLimits" in loading "ParamLimits", but data does not satisfy any constructor'
  );
}

export function storeParamLimits(
  ...
  return (builder: Builder) => {
    ...
    if (!(paramLimits.underload <= paramLimits.soft_limit)) {
      throw new Error(
        'Condition (paramLimits.underload <= paramLimits.soft_limit) is not satisfied while loading "ParamLimits" for type "ParamLimits"'
      );
    }
    if (!(paramLimits.soft_limit <= paramLimits.hard_limit)) {
      throw new Error(
        'Condition (paramLimits.soft_limit <= paramLimits.hard_limit) is not satisfied while loading "ParamLimits" for type "ParamLimits"'
      );
    }
  };
}
...
export function loadBlockLimits(slice: Slice): BlockLimits {
  ...
  throw new Error(
    'Expected one of "BlockLimits" in loading "BlockLimits", but data does not satisfy any constructor'
  );
}

export function storeBlockLimits(
...
export function loadMsgForwardPrices(slice: Slice): MsgForwardPrices {
  ...
  throw new Error(
    'Expected one of "MsgForwardPrices" in loading "MsgForwardPrices", but data does not satisfy any constructor'
  );
}

export function storeMsgForwardPrices(
...
export function loadCatchainConfig(slice: Slice): CatchainConfig {
  ...
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xc2) {
    ...
    if (!(flags == 0)) {
      throw new Error(
        'Condition (flags == 0) is not satisfied while loading "CatchainConfig_catchain_config_new" for type "CatchainConfig"'
      );
    }
    return {
  ...
  throw new Error(
    'Expected one of "CatchainConfig_catchain_config", "CatchainConfig_catchain_config_new" in loading "CatchainConfig", but data does not satisfy any constructor'
  );
}

export function storeCatchainConfig(
  ...
  if (catchainConfig.kind == "CatchainConfig_catchain_config_new") {
    return (builder: Builder) => {
      ...
      if (!(catchainConfig.flags == 0)) {
        throw new Error(
          'Condition (catchainConfig.flags == 0) is not satisfied while loading "CatchainConfig_catchain_config_new" for type "CatchainConfig"'
        );
      }
    };
  }
...
export function loadConsensusConfig(slice: Slice): ConsensusConfig {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xd6) {
    ...
    if (!(round_candidates >= 1)) {
      throw new Error(
        'Condition (round_candidates >= 1) is not satisfied while loading "ConsensusConfig_consensus_config" for type "ConsensusConfig"'
      );
    }
    return {
  ...
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xd7) {
    ...
    if (!(flags == 0)) {
      throw new Error(
        'Condition (flags == 0) is not satisfied while loading "ConsensusConfig_consensus_config_new" for type "ConsensusConfig"'
      );
    }
    if (!(round_candidates >= 1)) {
      throw new Error(
        'Condition (round_candidates >= 1) is not satisfied while loading "ConsensusConfig_consensus_config_new" for type "ConsensusConfig"'
      );
    }
    return {
  ...
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xd8) {
    ...
    if (!(flags == 0)) {
      throw new Error(
        'Condition (flags == 0) is not satisfied while loading "ConsensusConfig_consensus_config_v3" for type "ConsensusConfig"'
      );
    }
    if (!(round_candidates >= 1)) {
      throw new Error(
        'Condition (round_candidates >= 1) is not satisfied while loading "ConsensusConfig_consensus_config_v3" for type "ConsensusConfig"'
      );
    }
    return {
  ...
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xd9) {
    ...
    if (!(flags == 0)) {
      throw new Error(
        'Condition (flags == 0) is not satisfied while loading "ConsensusConfig_consensus_config_v4" for type "ConsensusConfig"'
      );
    }
    if (!(round_candidates >= 1)) {
      throw new Error(
        'Condition (round_candidates >= 1) is not satisfied while loading "ConsensusConfig_consensus_config_v4" for type "ConsensusConfig"'
      );
    }
    return {
  ...
  throw new Error(
    'Expected one of "ConsensusConfig_consensus_config", "ConsensusConfig_consensus_config_new", "ConsensusConfig_consensus_config_v3", "ConsensusConfig_consensus_config_v4" in loading "ConsensusConfig", but data does not satisfy any constructor'
  );
}

export function storeConsensusConfig(
  ...
  if (consensusConfig.kind == "ConsensusConfig_consensus_config") {
    return (builder: Builder) => {
      ...
      if (!(consensusConfig.round_candidates >= 1)) {
        throw new Error(
          'Condition (consensusConfig.round_candidates >= 1) is not satisfied while loading "ConsensusConfig_consensus_config" for type "ConsensusConfig"'
        );
      }
    };
  }
  if (consensusConfig.kind == "ConsensusConfig_consensus_config_new") {
    return (builder: Builder) => {
      ...
      if (!(consensusConfig.flags == 0)) {
        throw new Error(
          'Condition (consensusConfig.flags == 0) is not satisfied while loading "ConsensusConfig_consensus_config_new" for type "ConsensusConfig"'
        );
      }
      if (!(consensusConfig.round_candidates >= 1)) {
        throw new Error(
          'Condition (consensusConfig.round_candidates >= 1) is not satisfied while loading "ConsensusConfig_consensus_config_new" for type "ConsensusConfig"'
        );
      }
    };
  }
  if (consensusConfig.kind == "ConsensusConfig_consensus_config_v3") {
    return (builder: Builder) => {
      ...
      if (!(consensusConfig.flags == 0)) {
        throw new Error(
          'Condition (consensusConfig.flags == 0) is not satisfied while loading "ConsensusConfig_consensus_config_v3" for type "ConsensusConfig"'
        );
      }
      if (!(consensusConfig.round_candidates >= 1)) {
        throw new Error(
          'Condition (consensusConfig.round_candidates >= 1) is not satisfied while loading "ConsensusConfig_consensus_config_v3" for type "ConsensusConfig"'
        );
      }
    };
  }
  if (consensusConfig.kind == "ConsensusConfig_consensus_config_v4") {
    return (builder: Builder) => {
      ...
      if (!(consensusConfig.flags == 0)) {
        throw new Error(
          'Condition (consensusConfig.flags == 0) is not satisfied while loading "ConsensusConfig_consensus_config_v4" for type "ConsensusConfig"'
        );
      }
      if (!(consensusConfig.round_candidates >= 1)) {
        throw new Error(
          'Condition (consensusConfig.round_candidates >= 1) is not satisfied while loading "ConsensusConfig_consensus_config_v4" for type "ConsensusConfig"'
        );
      }
    };
  }
...
export function loadValidatorTempKey(slice: Slice): ValidatorTempKey {
  ...
  throw new Error(
    'Expected one of "ValidatorTempKey" in loading "ValidatorTempKey", but data does not satisfy any constructor'
  );
}

export function storeValidatorTempKey(
  validatorTempKey: ValidatorTempKey
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadValidatorSignedTempKey(
  slice: Slice
  ...
  throw new Error(
    'Expected one of "ValidatorSignedTempKey" in loading "ValidatorSignedTempKey", but data does not satisfy any constructor'
  );
}

export function storeValidatorSignedTempKey(
  validatorSignedTempKey: ValidatorSignedTempKey
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeUint(0x4, 4);
    let cell1 = beginCell();
...
export function loadMisbehaviourPunishmentConfig(
  slice: Slice
): MisbehaviourPunishmentConfig {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0x01) {
    slice.loadUint(8);
  ...
  throw new Error(
    'Expected one of "MisbehaviourPunishmentConfig" in loading "MisbehaviourPunishmentConfig", but data does not satisfy any constructor'
  );
}

export function storeMisbehaviourPunishmentConfig(
  ...
  return (builder: Builder) => {
    ...
    builder.storeUint(
      misbehaviourPunishmentConfig.default_proportional_fine,
      32
    );
    builder.storeUint(misbehaviourPunishmentConfig.severity_flat_mult, 16);
    builder.storeUint(
      misbehaviourPunishmentConfig.severity_proportional_mult,
      16
    );
    ...
    builder.storeUint(
      misbehaviourPunishmentConfig.medium_proportional_mult,
      16
    );
  };
}
...
export function loadSizeLimitsConfig(slice: Slice): SizeLimitsConfig {
  ...
  throw new Error(
    'Expected one of "SizeLimitsConfig_size_limits_config", "SizeLimitsConfig_size_limits_config_v2" in loading "SizeLimitsConfig", but data does not satisfy any constructor'
  );
}

export function storeSizeLimitsConfig(
...
export function loadSuspendedAddressList(slice: Slice): SuspendedAddressList {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0x00) {
    slice.loadUint(8);
    let addresses: Dictionary<bigint, Unit> = Dictionary.load(
      Dictionary.Keys.BigUint(288),
      {
        serialize: () => {
          throw new Error("Not implemented");
        },
  ...
  throw new Error(
    'Expected one of "SuspendedAddressList" in loading "SuspendedAddressList", but data does not satisfy any constructor'
  );
}

export function storeSuspendedAddressList(
  suspendedAddressList: SuspendedAddressList
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeUint(0x00, 8);
    builder.storeDict(
      suspendedAddressList.addresses,
      Dictionary.Keys.BigUint(288),
      {
...
export function loadPrecompiledSmc(slice: Slice): PrecompiledSmc {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xb0) {
    slice.loadUint(8);
    let gas_usage: number = slice.loadUint(64);
    return {
      kind: "PrecompiledSmc",
      gas_usage: gas_usage,
    };
  ...
  throw new Error(
    'Expected one of "PrecompiledSmc" in loading "PrecompiledSmc", but data does not satisfy any constructor'
  );
}

export function storePrecompiledSmc(
  precompiledSmc: PrecompiledSmc
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadPrecompiledContractsConfig(
  slice: Slice
): PrecompiledContractsConfig {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xc0) {
    slice.loadUint(8);
    let list: Dictionary<bigint, PrecompiledSmc> = Dictionary.load(
      Dictionary.Keys.BigUint(256),
      {
        serialize: () => {
          throw new Error("Not implemented");
  ...
  throw new Error(
    'Expected one of "PrecompiledContractsConfig" in loading "PrecompiledContractsConfig", but data does not satisfy any constructor'
  );
}

export function storePrecompiledContractsConfig(
  precompiledContractsConfig: PrecompiledContractsConfig
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeUint(0xc0, 8);
    builder.storeDict(
      precompiledContractsConfig.list,
      Dictionary.Keys.BigUint(256),
      {
...
export function loadOracleBridgeParams(slice: Slice): OracleBridgeParams {
  ...
  let oracles: Dictionary<bigint, bigint> = Dictionary.load(
    Dictionary.Keys.BigUint(256),
    {
      serialize: () => {
        throw new Error("Not implemented");
...
export function storeOracleBridgeParams(
...
export function storeJettonBridgePrices(
  jettonBridgePrices: JettonBridgePrices
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadJettonBridgeParams(slice: Slice): JettonBridgeParams {
  ...
  throw new Error(
    'Expected one of "JettonBridgeParams_jetton_bridge_params_v0", "JettonBridgeParams_jetton_bridge_params_v1" in loading "JettonBridgeParams", but data does not satisfy any constructor'
  );
}

export function storeJettonBridgeParams(
...
export function loadBlockSignaturesPure(slice: Slice): BlockSignaturesPure {
  ...
  let signatures: Dictionary<number, CryptoSignaturePair> = Dictionary.load(
    Dictionary.Keys.Uint(16),
    {
      serialize: () => {
        throw new Error("Not implemented");
...
export function storeBlockSignaturesPure(
  blockSignaturesPure: BlockSignaturesPure
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeUint(blockSignaturesPure.sig_count, 32);
    builder.storeUint(blockSignaturesPure.sig_weight, 64);
    builder.storeDict(
      blockSignaturesPure.signatures,
      Dictionary.Keys.Uint(16),
      {
        serialize: (arg: CryptoSignaturePair, builder: Builder) => {
          storeCryptoSignaturePair(arg)(builder);
...
export function loadBlockSignatures(slice: Slice): BlockSignatures {
  ...
  throw new Error(
    'Expected one of "BlockSignatures" in loading "BlockSignatures", but data does not satisfy any constructor'
  );
}

export function storeBlockSignatures(
...
export function loadBlockProof(slice: Slice): BlockProof {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xc3) {
    ...
    let slice1 = slice.loadRef().beginParse(true);
    let root: Cell = slice1.asCell();
    let signatures: Maybe<BlockSignatures> = loadMaybe<BlockSignatures>(
      slice,
      (slice: Slice) => {
        let slice1 = slice.loadRef().beginParse(true);
  ...
  throw new Error(
    'Expected one of "BlockProof" in loading "BlockProof", but data does not satisfy any constructor'
  );
}

export function storeBlockProof(
  ...
  return (builder: Builder) => {
    ...
    builder.storeRef(cell1);
    storeMaybe<BlockSignatures>(
      blockProof.signatures,
      (arg: BlockSignatures) => {
        return (builder: Builder) => {
          let cell1 = beginCell();
...
export function loadProofChain(slice: Slice, arg0: number): ProofChain {
  ...
  throw new Error(
    'Expected one of "ProofChain_chain_empty", "ProofChain_chain_link" in loading "ProofChain", but data does not satisfy any constructor'
  );
}

export function storeProofChain(
...
export function loadTopBlockDescr(slice: Slice): TopBlockDescr {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0xd5) {
    ...
    if (!(len >= 1)) {
      throw new Error(
        'Condition (len >= 1) is not satisfied while loading "TopBlockDescr" for type "TopBlockDescr"'
      );
    }
    if (!(len <= 8)) {
      throw new Error(
        'Condition (len <= 8) is not satisfied while loading "TopBlockDescr" for type "TopBlockDescr"'
      );
    }
    return {
      kind: "TopBlockDescr",
  ...
  throw new Error(
    'Expected one of "TopBlockDescr" in loading "TopBlockDescr", but data does not satisfy any constructor'
  );
}

export function storeTopBlockDescr(
  topBlockDescr: TopBlockDescr
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeUint(0xd5, 8);
    storeBlockIdExt(topBlockDescr.proof_for)(builder);
    storeMaybe<BlockSignatures>(
      topBlockDescr.signatures,
      (arg: BlockSignatures) => {
        return (builder: Builder) => {
          let cell1 = beginCell();
          storeBlockSignatures(arg)(cell1);
    ...
    if (!(topBlockDescr.len >= 1)) {
      throw new Error(
        'Condition (topBlockDescr.len >= 1) is not satisfied while loading "TopBlockDescr" for type "TopBlockDescr"'
      );
    }
    if (!(topBlockDescr.len <= 8)) {
      throw new Error(
        'Condition (topBlockDescr.len <= 8) is not satisfied while loading "TopBlockDescr" for type "TopBlockDescr"'
      );
    }
  };
}
...
export function loadTopBlockDescrSet(slice: Slice): TopBlockDescrSet {
  if (slice.remainingBits >= 32 && slice.preloadUint(32) == 0x4ac789f3) {
    slice.loadUint(32);
    let collection: Dictionary<bigint, TopBlockDescr> = Dictionary.load(
      Dictionary.Keys.BigUint(96),
      {
        serialize: () => {
          throw new Error("Not implemented");
  ...
  throw new Error(
    'Expected one of "TopBlockDescrSet" in loading "TopBlockDescrSet", but data does not satisfy any constructor'
  );
}

export function storeTopBlockDescrSet(
  topBlockDescrSet: TopBlockDescrSet
): (builder: Builder) => void {
  return (builder: Builder) => {
    builder.storeUint(0x4ac789f3, 32);
    builder.storeDict(
      topBlockDescrSet.collection,
      Dictionary.Keys.BigUint(96),
      {
...
export function loadProducerInfo(slice: Slice): ProducerInfo {
  if (slice.remainingBits >= 8 && slice.preloadUint(8) == 0x34) {
    ...
    let slice1 = slice.loadRef().beginParse(true);
    let state_proof: MERKLE_PROOF<Block> = loadMERKLE_PROOF<Block>(
      slice1,
      loadBlock
    );
    let slice2 = slice.loadRef().beginParse(true);
    let prod_proof: MERKLE_PROOF<ShardState> = loadMERKLE_PROOF<ShardState>(
      slice2,
      loadShardState
    );
    return {
  ...
  throw new Error(
    'Expected one of "ProducerInfo" in loading "ProducerInfo", but data does not satisfy any constructor'
  );
}

export function storeProducerInfo(
  ...
  return (builder: Builder) => {
    ...
    builder.storeRef(cell1);
    let cell2 = beginCell();
    storeMERKLE_PROOF<ShardState>(
      producerInfo.prod_proof,
      storeShardState
    )(cell2);
    builder.storeRef(cell2);
  };
...
export function loadComplaintDescr(slice: Slice): ComplaintDescr {
  ...
  throw new Error(
    'Expected one of "ComplaintDescr_no_blk_gen", "ComplaintDescr_no_blk_gen_diff" in loading "ComplaintDescr", but data does not satisfy any constructor'
  );
}

export function storeComplaintDescr(
  complaintDescr: ComplaintDescr
): (builder: Builder) => void {
...
export function loadValidatorComplaint(slice: Slice): ValidatorComplaint {
  ...
  throw new Error(
    'Expected one of "ValidatorComplaint" in loading "ValidatorComplaint", but data does not satisfy any constructor'
  );
}

export function storeValidatorComplaint(
  validatorComplaint: ValidatorComplaint
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadValidatorComplaintStatus(
  slice: Slice
  ...
  throw new Error(
    'Expected one of "ValidatorComplaintStatus" in loading "ValidatorComplaintStatus", but data does not satisfy any constructor'
  );
}

export function storeValidatorComplaintStatus(
  validatorComplaintStatus: ValidatorComplaintStatus
): (builder: Builder) => void {
  return (builder: Builder) => {
    ...
    builder.storeRef(cell1);
    builder.storeDict(
      validatorComplaintStatus.voters,
      Dictionary.Keys.Uint(16),
      {
        serialize: (arg: True, builder: Builder) => {
          storeTrue(arg)(builder);
...
export function loadVmCellSlice(slice: Slice): VmCellSlice {
  ...
  if (!(st_bits <= end_bits)) {
    throw new Error(
      'Condition (st_bits <= end_bits) is not satisfied while loading "VmCellSlice" for type "VmCellSlice"'
    );
  }
  if (!(st_ref <= end_ref)) {
    throw new Error(
      'Condition (st_ref <= end_ref) is not satisfied while loading "VmCellSlice" for type "VmCellSlice"'
    );
  }
  return {
    kind: "VmCellSlice",
...
export function storeVmCellSlice(
  vmCellSlice: VmCellSlice
): (builder: Builder) => void {
  return (builder: Builder) => {
    let cell1 = beginCell();
    ...
    if (!(vmCellSlice.st_bits <= vmCellSlice.end_bits)) {
      throw new Error(
        'Condition (vmCellSlice.st_bits <= vmCellSlice.end_bits) is not satisfied while loading "VmCellSlice" for type "VmCellSlice"'
      );
    }
    if (!(vmCellSlice.st_ref <= vmCellSlice.end_ref)) {
      throw new Error(
        'Condition (vmCellSlice.st_ref <= vmCellSlice.end_ref) is not satisfied while loading "VmCellSlice" for type "VmCellSlice"'
      );
    }
  };
}
...
export function loadVmTupleRef(slice: Slice, arg0: number): VmTupleRef {
  ...
  throw new Error(
    'Expected one of "VmTupleRef_vm_tupref_nil", "VmTupleRef_vm_tupref_single", "VmTupleRef_vm_tupref_any" in loading "VmTupleRef", but data does not satisfy any constructor'
  );
}

export function storeVmTupleRef(
...
export function loadVmTuple(slice: Slice, arg0: number): VmTuple {
  ...
  throw new Error(
    'Expected one of "VmTuple_vm_tuple_nil", "VmTuple_vm_tuple_tcons" in loading "VmTuple", but data does not satisfy any constructor'
  );
}
...
export function loadVmStackList(slice: Slice, arg0: number): VmStackList {
  ...
  throw new Error(
    'Expected one of "VmStackList_vm_stk_nil", "VmStackList_vm_stk_cons" in loading "VmStackList", but data does not satisfy any constructor'
  );
}

export function storeVmStackList(
  vmStackList: VmStackList
): (builder: Builder) => void {
...
export function loadVmSaveList(slice: Slice): VmSaveList {
  let cregs: Dictionary<number, VmStackValue> = Dictionary.load(
...
export function storeVmSaveList(
  vmSaveList: VmSaveList
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function storeVmGasLimits(
...
export function loadVmLibraries(slice: Slice): VmLibraries {
  let libraries: Dictionary<bigint, Cell> = Dictionary.load(
    Dictionary.Keys.BigUint(256),
    {
      serialize: () => {
        throw new Error("Not implemented");
...
export function storeVmLibraries(
  vmLibraries: VmLibraries
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function storeVmControlData(
  vmControlData: VmControlData
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadVmCont(slice: Slice): VmCont {
  ...
  throw new Error(
    'Expected one of "VmCont_vmc_std", "VmCont_vmc_envelope", "VmCont_vmc_quit", "VmCont_vmc_quit_exc", "VmCont_vmc_repeat", "VmCont_vmc_until", "VmCont_vmc_again", "VmCont_vmc_while_cond", "VmCont_vmc_while_body", "VmCont_vmc_pushint" in loading "VmCont", but data does not satisfy any constructor'
  );
}
...
export function loadDNS_RecordSet(slice: Slice): DNS_RecordSet {
  let anon0: Dictionary<bigint, DNSRecord> = Dictionary.load(
    Dictionary.Keys.BigUint(256),
    {
      serialize: () => {
        throw new Error("Not implemented");
...
export function storeDNS_RecordSet(
...
export function loadTextChunkRef(slice: Slice, arg0: number): TextChunkRef {
  ...
  throw new Error(
    'Expected one of "TextChunkRef_chunk_ref_empty", "TextChunkRef_chunk_ref" in loading "TextChunkRef", but data does not satisfy any constructor'
  );
}

export function storeTextChunkRef(
  textChunkRef: TextChunkRef
): (builder: Builder) => void {
...
export function loadTextChunks(slice: Slice, arg0: number): TextChunks {
  ...
  throw new Error(
    'Expected one of "TextChunks_text_chunk_empty", "TextChunks_text_chunk" in loading "TextChunks", but data does not satisfy any constructor'
  );
}

export function storeTextChunks(
...
export function loadDNSRecord(slice: Slice): DNSRecord {
  ...
  if (slice.remainingBits >= 16 && slice.preloadUint(16) == 0xad01) {
    ...
    let adnl_addr: BitString = slice.loadBits(256);
    let flags: number = slice.loadUint(8);
    let proto_list: ProtoList | undefined =
      flags & (1 << 0) ? loadProtoList(slice) : undefined;
    if (!(flags <= 1)) {
      throw new Error(
        'Condition (flags <= 1) is not satisfied while loading "DNSRecord_dns_adnl_address" for type "DNSRecord"'
      );
    }
    return {
  ...
  if (slice.remainingBits >= 16 && slice.preloadUint(16) == 0x9fd3) {
    ...
    let flags: number = slice.loadUint(8);
    let cap_list: SmcCapList | undefined =
      flags & (1 << 0) ? loadSmcCapList(slice) : undefined;
    if (!(flags <= 1)) {
      throw new Error(
        'Condition (flags <= 1) is not satisfied while loading "DNSRecord_dns_smc_address" for type "DNSRecord"'
      );
    }
    return {
  ...
  throw new Error(
    'Expected one of "DNSRecord_dns_text", "DNSRecord_dns_next_resolver", "DNSRecord_dns_adnl_address", "DNSRecord_dns_smc_address", "DNSRecord_dns_storage_address" in loading "DNSRecord", but data does not satisfy any constructor'
  );
}

export function storeDNSRecord(
  dNSRecord: DNSRecord
): (builder: Builder) => void {
  ...
  if (dNSRecord.kind == "DNSRecord_dns_adnl_address") {
    return (builder: Builder) => {
      ...
      if (!(dNSRecord.flags <= 1)) {
        throw new Error(
          'Condition (dNSRecord.flags <= 1) is not satisfied while loading "DNSRecord_dns_adnl_address" for type "DNSRecord"'
        );
      }
    };
  }
  if (dNSRecord.kind == "DNSRecord_dns_smc_address") {
    return (builder: Builder) => {
      ...
      if (!(dNSRecord.flags <= 1)) {
        throw new Error(
          'Condition (dNSRecord.flags <= 1) is not satisfied while loading "DNSRecord_dns_smc_address" for type "DNSRecord"'
        );
      }
    };
  }
...
export function loadProtoList(slice: Slice): ProtoList {
  ...
  throw new Error(
    'Expected one of "ProtoList_proto_list_nil", "ProtoList_proto_list_next" in loading "ProtoList", but data does not satisfy any constructor'
  );
}

export function storeProtoList(
  protoList: ProtoList
): (builder: Builder) => void {
...
export function loadProtocol(slice: Slice): Protocol {
  ...
  throw new Error(
    'Expected one of "Protocol" in loading "Protocol", but data does not satisfy any constructor'
  );
}
...
export function loadSmcCapList(slice: Slice): SmcCapList {
  ...
  throw new Error(
    'Expected one of "SmcCapList_cap_list_nil", "SmcCapList_cap_list_next" in loading "SmcCapList", but data does not satisfy any constructor'
  );
}

export function storeSmcCapList(
  smcCapList: SmcCapList
): (builder: Builder) => void {
...
export function loadSmcCapability(slice: Slice): SmcCapability {
  ...
  throw new Error(
    'Expected one of "SmcCapability_cap_method_seqno", "SmcCapability_cap_method_pubkey", "SmcCapability_cap_is_wallet", "SmcCapability_cap_name" in loading "SmcCapability", but data does not satisfy any constructor'
  );
}

export function storeSmcCapability(
  smcCapability: SmcCapability
): (builder: Builder) => void {
...
export function storeChanConfig(
...
export function loadChanState(slice: Slice): ChanState {
  ...
  throw new Error(
    'Expected one of "ChanState_chan_state_init", "ChanState_chan_state_close", "ChanState_chan_state_payout" in loading "ChanState", but data does not satisfy any constructor'
  );
}

export function storeChanState(
  chanState: ChanState
): (builder: Builder) => void {
...
export function storeChanPromise(
  chanPromise: ChanPromise
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function storeChanSignedPromise(
  chanSignedPromise: ChanSignedPromise
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadChanMsg(slice: Slice): ChanMsg {
  ...
  throw new Error(
    'Expected one of "ChanMsg_chan_msg_init", "ChanMsg_chan_msg_close", "ChanMsg_chan_msg_timeout", "ChanMsg_chan_msg_payout" in loading "ChanMsg", but data does not satisfy any constructor'
  );
}
...
export function storeChanSignedMsg(
  chanSignedMsg: ChanSignedMsg
): (builder: Builder) => void {
  return (builder: Builder) => {
...
export function loadChanOp(slice: Slice): ChanOp {
  ...
  throw new Error(
    'Expected one of "ChanOp" in loading "ChanOp", but data does not satisfy any constructor'
  );
}
