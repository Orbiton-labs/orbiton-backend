...
export const sqlCommands = {
  create: {
    [TableName.Pool]: `CREATE TABLE IF NOT EXISTS ${TableName.Pool}
      (
        poolAddress VARCHAR PRIMARY KEY,
        jetton0Address VARCHAR,
        jetton1Address VARCHAR,
        fee VARCHAR,
        tickSpacing VARCHAR
      )
      `,
    [TableName.Position]: `CREATE TABLE IF NOT EXISTS ${TableName.Position}
      (
        poolAddress VARCHAR,
        positionAddress VARCHAR PRIMARY KEY,
        tickLower VARCHAR,
        tickUpper VARCHAR,
        liquidity VARCHAR,
        feeGrowthInside0LastX128 VARCHAR,
        feeGrowthInside1LastX128 VARCHAR,
        tokenOwed0 VARCHAR,
        tokenOwed1 VARCHAR,
